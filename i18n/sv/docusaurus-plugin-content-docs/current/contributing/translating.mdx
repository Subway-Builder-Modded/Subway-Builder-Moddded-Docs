...
1. Navigate to the folder corresponding to your language in `i18n/YOUR_LOCALE_CODE`. For example, Spanish translations are located in `i18n/es-ES`.
...
4. Do **not** attempt to translate automatically generated content from Docusaurus updates; these cannot be translated due to limitations in the framework.
5. PR Requirements:
...
2. Copy all files from `docs/` and `modding-docs/` into `current`.
...
## Important Notes {#important-notes}
 ...
 - **Needs-Translating Tag:** Any PR merged with the `needs-translating` tag must be translated by contributors.  
 - **Formatting Matters:** Maintain code blocks, notes, headings, lists, and image references exactly as in the original files.  
 - **Responsibility:** Translators are fully responsible for the accuracy and completeness of their language folder.  
 - **Updates Limitations:** Automatic updates from Docusaurus cannot be translated; focus on manual translation of content.  
