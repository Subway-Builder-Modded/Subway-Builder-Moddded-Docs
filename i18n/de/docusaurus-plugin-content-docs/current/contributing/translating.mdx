...
4. Versuche **nicht**, automatisch generierte Inhalte von Docosaurus-Updates zu übersetzen. Das ist aufgrund von Einschränkungen im Framework nicht möglich.
5. PR Anforderungen:
...
2. Füge Deine Sprache im Abschnitt `localeConfigs` Hinzu. Beispiel:
```js
locales: ['en', 'es', 'fr', /* Deine Sprache hier */ 'it'],
localeConfigs: {
  en: {
    label: 'English',
    htmlLang: 'en-GB',
