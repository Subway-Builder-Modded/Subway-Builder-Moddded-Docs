...
ist die einfachste und optimierteste Herangehensweise, eigene Städte im Subway Builder zu
installieren. Alles was Du benötigst ist eine bereitgestellte ZIP-Datei der Karte und den Map
Manager selber, und schon kannst Du loslegen.
...
Für Windows benötigst Du die `.exe` Datei. Für Linux nutzt Du die `.zip` Datei. Für MacOS
...
Auf MacOS wird der .dmg Installer wahrscheinlich in die Quarantäne versetzt. Um den
...
Aufgrund der Art, wie das Spiel aktuell funktioniet, musst Du es jedes mal über den Map
