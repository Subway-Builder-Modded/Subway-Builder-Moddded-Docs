...
Windows benötigst Du die `.exe` Datei. Für Linux nutzt Du die `.zip` Datei. Für MacOS
...
MacOS wird der .dmg Installer wahrscheinlich in die Quarantäne versetzt. Um den
...
der Art, wie das Spiel aktuell funktioniet, musst Du es jedes mal über den Map
