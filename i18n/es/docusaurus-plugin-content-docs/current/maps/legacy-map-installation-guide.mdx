...
En Windows y Linux, puedes usar [7-Zip](https://www.7-zip.org/download.html) para extraer el
...
Debido a la forma en que funciona actualmente el juego, debes iniciar el juego a través
