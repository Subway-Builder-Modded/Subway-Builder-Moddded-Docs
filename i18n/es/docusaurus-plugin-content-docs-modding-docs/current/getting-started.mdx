...
Antes de comenzar, deberías tener una comprensión básica de **JavaScript** o
...
En Windows, puede que necesites ejecutar tu terminal como Administrador para que el symlink
funcione.
