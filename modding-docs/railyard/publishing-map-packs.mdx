...
Once you have the repository set up, create a new release. In this release, place **ALL** the ZIP files containing your maps (as different release assets). They should contain **exactly** files that will go in the player's `metro-maker4/cities/data` folder (in the correct format).
