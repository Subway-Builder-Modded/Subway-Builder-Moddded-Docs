...
:::tip The thumbnail is optional, however if you do not set it, it will appear blank.
...
:::important This currently will not work for United States or United Kingdom maps, as those
...
:::note All custom maps will still be categorized under the "`Custom`" tab in the map creation
