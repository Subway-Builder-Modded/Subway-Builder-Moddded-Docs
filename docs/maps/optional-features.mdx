...
thumbnail is optional, however if you do not set it, it will appear blank.
...
currently will not work for United States or United Kingdom maps, as those
...
custom maps will still be categorized under the "`Custom`" tab in the map creation
