...
[Kronifer's Map Manager](https://github.com/Subway-Builder-Modded/subwaybuilder-patcher/releases) is the easiest and most streamlined way to download and install custom cities into Subway Builder. All you need is a provided ZIP file and the Map Manager iself, and then you're good to go.

## Step 1 - Installing the Map Manager {#installing-the-map-manager}

Download the latest release of the Map Manager at https://github.com/Subway-Builder-Modded/subwaybuilder-patcher/releases. To download, click on the version that corresponds to your operating system.
