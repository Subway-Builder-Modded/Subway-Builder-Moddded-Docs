...
```bash
git clone -b legacy https://github.com/kronifer/subwaybuilder-patcher
```
...
:::
 - "BBox": the coordinates of the bounding box for your city. This should be in the format `[minLat /*East*/, minLon /*South*/, maxLat /*West*/, maxLon /*North*/]`.
...
:::tip
For more optional features that can be included in `config.json`, check the [optional features page](/wiki/maps/optional-features).
:::
