            ...
            <span class="updates-icon">
              <svg width="13"
                ...
                <g fill="none"
                  ...
                  stroke-width="1.5">
                  <path d="M7 9v6m0-6H6c-.932 0-1.398 0-1.765.152a2 2 0 0 0-1.083 1.083C3 10.602 3 11.068 3 12s0 1.398.152 1.765a2 2 0 0 0 1.083 1.083C4.602 15 5.068 15 6 15h1l8.08 2.424c.95.285 1.424.427 1.846.677l.02.012c.42.253.77.604 1.472 1.305l.168.168c.12.12.179.179.245.226a1 1 0 0 0 .421.175c.08.013.165.013.334.013c.385 0 .578 0 .734-.052a1 1 0 0 0 .628-.628c.052-.156.052-.349.052-.734V5.414c0-.385 0-.578-.052-.734a1 1 0 0 0-.628-.628C20.164 4 19.97 4 19.586 4c-.169 0-.253 0-.334.013a1 1 0 0 0-.421.175c-.066.047-.126.107-.245.226l-.168.168c-.701.701-1.052 1.052-1.472 1.304l-.02.013c-.422.25-.897.392-1.846.677z"/>
                  <path d="M8 15.5v2.546a1.954 1.954 0 0 0 3.58 1.084L13 17"/>
                </g>
              </svg>
              Updates
            </span>
